    ...
    <div class="row">
        <div class="col-md-8" style="background:lightgray;">
            ...
            <form action="{{url('pages/topic/createComment')}}" method="POST"> @csrf
                <textarea class="form-control" style="background-color: ghostwhite; display:block; margin-left:auto; margin-right:auto" name="comment_content" id="comment_content" cols="50" rows="5" placeholder="Cảm nghĩ của bạn..."></textarea>
                <br>
