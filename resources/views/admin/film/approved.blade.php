        ...
        @foreach ($ds as $item )
            <tr class="text-center">
                ...
                <td class="text-center">
                    ...
                    <a class="btn btn-danger btn-sm" href="{{ url("admin/film/approved/{$item->film_id}") }}" onclick="javascript:return confirm('Bạn có chắc chắn muốn xóa  {{$item->film_title}} không ?')">
