...
<br>
<h2 style="color: goldenrod; font-weight: bold; text-align:center">DANH SÁCH PHIM </h2>
...
<table class="table table-hover table-striped " id="film">
    ...
    <tbody>
        @foreach ($ds as $item )
            <tr class="text-center">
                <td> {{$item->film_id}} </td>
                <td> <img src="{{asset("images/phim/$item->film_poster")}}" width="150px" > </td>
                ...
                <td class="text-center">
                    ...
                    <a class="btn btn-danger btn-sm" href="{{url("admin/film/index/{$item->film_id}")}}" onclick="javascript:return confirm('Bạn có chắc chắn muốn xóa {{$item->film_title}} không ?')">
