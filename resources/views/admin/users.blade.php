...
@section('main-content')
    <div class="container-fluid">
        <table class="table table-hover table-striped" id="nguoidung">
            <br>
            <h2 style="color: goldenrod; font-weight: bold; text-align:center">DANH SÁCH NGƯỜI DÙNG</h2><br>
                ...
                @foreach ($ds as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            onclick="javascript:return confirm('Bạn có chắc chắn muốn xóa tài khoản {{ $user->username }}?')"><i class="fas fa-trash"></i>
                            Xóa</a>
                        </td>
                    </tr>
                @endforeach
